...
Feature: As a user I would like to check CRUD operation of the application
  ...
  Scenario: I want to fetch all employees and verify some from the response
    ...
    And I verify employee id 21 has employee salary is 345000
    And I verify employee id 16 has employee age is 66
    And I verify employee id 10 has employee salary is "Sonya Frost"
